Animus
======
A text to image Anima GUI for machines without CUDA, AVX2, and so on. Also a Real-ESRGAN video upscaler with completely different design goals (try ```NCNN=1 make install```).
